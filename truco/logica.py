...
def reiniciarJogo(dados, jogador1, jogador2, baralho, envido, truco):
...
def turno_do_humano(jogador2, jogador1, cbr, interface, envido, dados, truco, flor):
...
def turno_do_bot(carta_jogador_01, jogador2, dados, cbr, truco, jogador1, flor, interface, envido):
...
def main(jogo, baralho, cbr, interface, dados, truco, flor, envido, jogador1, jogador2):
    # jogo = Jogo()
    # baralho = Baralho()
    ...
    while True:
        ...
        if jogador1.primeiro == True:
            carta_jogador_01 = turno_do_humano(jogador2, jogador1, cbr, interface, envido, dados, truco, flor)
            if (carta_jogador_01 != -1):
                interface.mostrar_carta_jogada(jogador1.nome, carta_jogador_01)
                carta_jogador_02 = turno_do_bot(carta_jogador_01, jogador2, dados, cbr, truco, jogador1, flor, interface, envido)
                if (carta_jogador_02 != -1):
                    interface.mostrar_carta_jogada(jogador2.nome, carta_jogador_02)

        elif jogador2.primeiro == True:
            carta_jogador_02 = turno_do_bot(None, jogador2, dados, cbr, truco, jogador1, flor, interface, envido)
            if (carta_jogador_02 != -1):
                interface.mostrar_carta_jogada(jogador2.nome, carta_jogador_02)
                carta_jogador_01 = turno_do_humano(jogador2, jogador1, cbr, interface, envido, dados, truco, flor)
                if (carta_jogador_01 != -1):
        ...
        if (jogador1.rodadas == 2 or jogador2.rodadas == 2):
            ...
            if jogador1.rodadas == 2:
                ...
                reiniciarJogo(dados, jogador1, jogador2, baralho, envido, truco)
